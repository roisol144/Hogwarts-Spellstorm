        ...
        IEnumerator AnimateVertexColors()
        {
            ...
            while (true)
            {
                ...
                for (int i = 0; i < characterCount; i++)
                {
                    ...
                    Vector3[] destinationVertices = new Vector3[sourceVertices.Length];
                    ...
                    Vector3[] destinationVertices3D = textInfo.meshInfo[materialIndex].vertices;

                    destinationVertices3D[vertexIndex + 0] = sourceVertices[vertexIndex + 0] - offset;
                    destinationVertices3D[vertexIndex + 1] = sourceVertices[vertexIndex + 1] - offset;
                    destinationVertices3D[vertexIndex + 2] = sourceVertices[vertexIndex + 2] - offset;
                    destinationVertices3D[vertexIndex + 3] = sourceVertices[vertexIndex + 3] - offset;
                    ...
                    destinationVertices3D[vertexIndex + 0] = matrix.MultiplyPoint3x4(destinationVertices3D[vertexIndex + 0]);
                    destinationVertices3D[vertexIndex + 1] = matrix.MultiplyPoint3x4(destinationVertices3D[vertexIndex + 1]);
                    destinationVertices3D[vertexIndex + 2] = matrix.MultiplyPoint3x4(destinationVertices3D[vertexIndex + 2]);
                    destinationVertices3D[vertexIndex + 3] = matrix.MultiplyPoint3x4(destinationVertices3D[vertexIndex + 3]);

                    destinationVertices3D[vertexIndex + 0] += offset;
                    destinationVertices3D[vertexIndex + 1] += offset;
                    destinationVertices3D[vertexIndex + 2] += offset;
                    destinationVertices3D[vertexIndex + 3] += offset;
