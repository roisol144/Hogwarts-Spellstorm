...
namespace Oculus.Voice.Demo
{
    public class InteractionHandler : MonoBehaviour
    {
        ...
        [SerializeField] private WitAiAgent witAiAgent;
        ...
        private void OnEnable()
        {
            ...
            if (witAiAgent != null)
                appVoiceExperience.VoiceEvents.OnResponse.AddListener(witAiAgent.OnResponse);
        }
        // Remove delegates
        private void OnDisable()
        {
            ...
            if (witAiAgent != null)
                appVoiceExperience.VoiceEvents.OnResponse.RemoveListener(witAiAgent.OnResponse);
        }
